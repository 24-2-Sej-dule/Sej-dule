...
new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [
      ...
      {
        label: "이용 가능 시간",
        data: [1.5, 1.5, 1.5, 1.5, 0], // 데이터 값
        borderRadius: 50,
        backgroundColor: "rgba(251, 140, 0, 1)", // #fb8c00을 rgba로 변경
      },
      {
        label: "강의 시간",
        data: [6, 5, 6, 5, 3], // 데이터 값
        backgroundColor: "rgba(0, 0, 0, 0.0)", // 막대 색상
      },
      {
        label: "이용 가능 시간",
        data: [1.5, 0, 3, 2.5, 9], // 데이터 값
        borderRadius: 50,
        backgroundColor: "rgba(251, 140, 0, 1)", // #fb8c00을 rgba로 변경
      },
      {
        label: "강의 시간",
        data: [1.5, 0, 1.5, 1, 0], // 데이터 값
        backgroundColor: "rgba(0, 0, 0, 0.0)", // 막대 색상
      },
      {
        label: "강의 시간",
      ...
      {
        label: "이용 가능 시간",
        data: [3, 1, 2, 0, 0], // 데이터 값
        borderRadius: 50,
        backgroundColor: "rgba(251, 140, 0, 1)", // #fb8c00을 rgba로 변경
      },
      {
        label: "강의 시간",
        data: [15, 2, 18, 7, 18], // 데이터 값
        backgroundColor: "rgba(0, 0, 0, 0)", // 막대 색상
      },
      {
        label: "이용 가능 시간",
        data: [15, 0.5, 18, 7, 18], // 데이터 값
        backgroundColor: "rgba(251, 140, 0, 1)", // #fb8c00을 rgba로 변경
      },
    ],
  },
